...
<body>
  ...
  <nav class="navbar navbar-expand-lg fixed-top ">
    <h1> <a class="navbar-brand" href="index.php">MARHABA </a></h1>
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      <ul class="navbar-nav mr-4">
        ...
        <li class="nav-item">
          <a class="nav-link " href="reservation.php">Reservez</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="ShowReservations.php">Show Reservation</a>
        </li>

        <li class="nav-item">
          <a href="../controllers/LogOut.php"><button id="logout" type="button" class="btn btn-outline-warning text-white ms-4">Log Out <?php echo $_SESSION['fullname'] ?> </button></a>
        </li>
      </ul>
    ...
    <div class="forme">
      <form action="" method="POST">
        ...
        <div id="enfantsExiste">
          ...
          <input type="number" name="nbrbaby" id="un">
          <div id="uno"></div>
          <p>Entrez l'age des enfants entre 2 et 10</p>
          <input type="number" name="nbrjunior" id="deux">
          <div id="dos"></div>
          <p>Entrez l'age des enfants plus de 14</p>
          <input type="number" name="nbrsenior" id="trois">
          <div id="tres"></div>
